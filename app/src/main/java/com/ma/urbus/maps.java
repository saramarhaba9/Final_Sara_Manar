    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isGranted) {
            if (checkGooglePlayServices()) {
                ...
                Toast.makeText(this, "Google NOT Available ", Toast.LENGTH_SHORT).show();
            }
        }
...
//                }
                ...
                if (location==null){
                    Toast.makeText(maps.this,"Try any Location name", Toast.LENGTH_SHORT).show();
                }else {
        ...
        if (resutl == ConnectionResult.SUCCESS)
            ...
            Dialog dialog = googleApiAvailability.getErrorDialog(this, resutl, 201, new DialogInterface.OnCancelListener() {
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    Toast.makeText(maps.this, "User conceled Dialoage", Toast.LENGTH_SHORT).show();
                }
            });
            dialog.show();
        }
    ...
    private void chceckPermission() {
        Dexter.withContext(this).withPermission(Manifest.permission.ACCESS_FINE_LOCATION).withListener(new PermissionListener() {
            ...
            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                isGranted = true;
                Toast.makeText(maps.this, "permision Granter", Toast.LENGTH_SHORT).show();
            }
...
//        this.googleMap = googleMap;
        LatLng latLng = new LatLng(212106.3,395414.9);
        MarkerOptions markerOptions = new MarkerOptions();
